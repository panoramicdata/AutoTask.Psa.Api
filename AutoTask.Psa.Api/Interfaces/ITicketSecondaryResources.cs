...
/// </summary>
public interface ITicketSecondaryResources
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<TicketSecondaryResourceModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<TicketSecondaryResourceModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<TicketSecondaryResourceModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
