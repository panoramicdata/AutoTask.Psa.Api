...
/// </summary>
public interface IOrganizationalResources
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<OrganizationalResourceModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<OrganizationalResourceModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<OrganizationalResourceModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
