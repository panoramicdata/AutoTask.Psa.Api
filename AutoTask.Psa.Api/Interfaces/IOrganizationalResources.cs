...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IOrganizationalResources
	{
		...
		Task<QueryActionResult<OrganizationalResourceModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<OrganizationalResourceModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<OrganizationalResourceModel>> QueryAsync([AliasAs("search")] string search);
