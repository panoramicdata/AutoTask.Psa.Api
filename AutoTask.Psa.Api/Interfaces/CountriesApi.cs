...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICountriesApi
	{
		...
		Task<CountryModel> PatchAsync([Body] CountryModel entity);
		...
		Task<CountryModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<CountryModel> GetAsync([AliasAs("id")] long id);
		...
		/// <returns>Task of CountryModel</returns>
		[Put("/V1.0/Countries")]
		Task<CountryModel> UpdateAsync([Body] CountryModel entity);
		...
		Task<CountryModel> QueryAsync([AliasAs("search")] string search);
