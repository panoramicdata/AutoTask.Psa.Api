...
/// </summary>
public interface IProjectCharges
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ProjectChargeModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ProjectChargeModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ProjectChargeModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
