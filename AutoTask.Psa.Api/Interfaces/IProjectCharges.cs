...
public interface IProjectCharges
{
	...
	Task<QueryActionResult<ProjectChargeModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ProjectChargeModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ProjectChargeModel>> QueryAsync([AliasAs("search")] string search);
