...
public interface IHolidaySets
{
	...
	Task<HolidaySetModel> CreateAsync([Body] HolidaySetModel entity);
	...
	Task<HolidaySetModel> PatchAsync([Body] HolidaySetModel entity);
	...
	Task<HolidaySetModel> GetAsync([AliasAs("id")] long id);
	...
	Task<HolidaySetModel> UpdateAsync([Body] HolidaySetModel entity);
	...
	Task<QueryActionResult<HolidaySetModel>> QueryAsync([AliasAs("search")] string search);
