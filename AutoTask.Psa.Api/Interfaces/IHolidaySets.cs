...
public interface IHolidaySets
{
	...
	Task<HolidaySetModel> CreateAsync([Body] HolidaySetModel entity, CancellationToken cancellationToken);
	...
	Task<HolidaySetModel> PatchAsync([Body] HolidaySetModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<HolidaySetModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<HolidaySetModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<HolidaySetModel> UpdateAsync([Body] HolidaySetModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<HolidaySetModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
