...
/// </summary>
public interface IResourceSkills
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ResourceSkillModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ResourceSkillModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ResourceSkillModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
