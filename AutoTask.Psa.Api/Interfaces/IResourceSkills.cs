...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IResourceSkills
	{
		...
		Task<QueryActionResult<ResourceSkillModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ResourceSkillModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<ResourceSkillModel>> QueryAsync([AliasAs("search")] string search);
