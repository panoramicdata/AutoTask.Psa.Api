...
/// </summary>
public interface IShippingTypes
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ShippingTypeModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ShippingTypeModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ShippingTypeModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
