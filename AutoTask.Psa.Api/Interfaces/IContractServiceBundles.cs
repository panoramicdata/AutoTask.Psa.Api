...
public interface IContractServiceBundles
{
	...
	Task<QueryActionResult<ContractServiceBundleModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContractServiceBundleModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContractServiceBundleModel>> QueryAsync([AliasAs("search")] string search);
