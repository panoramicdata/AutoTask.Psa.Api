...
/// </summary>
public interface IContractServiceBundles
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractServiceBundleModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractServiceBundleModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractServiceBundleModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
