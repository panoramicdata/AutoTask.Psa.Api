...
/// </summary>
public interface ICompanyWebhookUdfFields
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<CompanyWebhookUdfFieldModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<CompanyWebhookUdfFieldModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<CompanyWebhookUdfFieldModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
