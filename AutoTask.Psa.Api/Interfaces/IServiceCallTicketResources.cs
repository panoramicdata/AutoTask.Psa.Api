...
public interface IServiceCallTicketResources
{
	...
	Task<QueryActionResult<ServiceCallTicketResourceModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ServiceCallTicketResourceModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ServiceCallTicketResourceModel>> QueryAsync([AliasAs("search")] string search);
