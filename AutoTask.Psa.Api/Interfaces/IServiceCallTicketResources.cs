...
/// </summary>
public interface IServiceCallTicketResources
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ServiceCallTicketResourceModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ServiceCallTicketResourceModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ServiceCallTicketResourceModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
