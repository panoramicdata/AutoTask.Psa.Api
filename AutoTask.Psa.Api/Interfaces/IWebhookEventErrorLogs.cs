...
/// </summary>
public interface IWebhookEventErrorLogs
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<WebhookEventErrorLogModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<WebhookEventErrorLogModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<WebhookEventErrorLogModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
