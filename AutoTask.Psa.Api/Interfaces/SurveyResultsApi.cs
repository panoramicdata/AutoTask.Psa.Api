...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ISurveyResultsApi
	{
		...
		Task<SurveyResultsModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<SurveyResultsModel> GetAsync([AliasAs("id")] long id);
		...
		Task<SurveyResultsModel> QueryAsync([AliasAs("search")] string search);
