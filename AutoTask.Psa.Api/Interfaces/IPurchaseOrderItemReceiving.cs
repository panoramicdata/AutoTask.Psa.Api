...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IPurchaseOrderItemReceiving
	{
		...
		Task<QueryActionResult<PurchaseOrderItemReceivingModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<QueryActionResult<PurchaseOrderItemReceivingModel>> QueryAsync([AliasAs("search")] string search);
