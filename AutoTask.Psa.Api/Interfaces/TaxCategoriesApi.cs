...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface ITaxCategoriesApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<TaxCategoryModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<TaxCategoryModel> StringQueryAsync([AliasAs("search")] string search);
