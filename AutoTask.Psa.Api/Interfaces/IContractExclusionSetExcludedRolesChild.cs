...
public interface IContractExclusionSetExcludedRolesChild
{
	...
	Task<ContractExclusionSetExcludedRoleModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ContractExclusionSetExcludedRoleModel entity, CancellationToken cancellationToken);
