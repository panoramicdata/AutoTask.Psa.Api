...
/// </summary>
public interface ITicketAdditionalConfigurationItemsChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<TicketAdditionalConfigurationItemModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] TicketAdditionalConfigurationItemModel entity, CancellationToken cancellationToken);
	...
	Task<TicketAdditionalConfigurationItemModel> QueryAsync([AliasAs("parentId")] long? parentId);
	...
	Task<TicketAdditionalConfigurationItemModel> GetAsync([AliasAs("parentId")] long? parentId, [AliasAs("id")] long? id);
