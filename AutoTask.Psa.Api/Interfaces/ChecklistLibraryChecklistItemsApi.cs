...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IChecklistLibraryChecklistItemsApi
	{
		...
		Task<ChecklistLibraryChecklistItemModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ChecklistLibraryChecklistItemModel> StringQueryAsync([AliasAs("search")] string search);
