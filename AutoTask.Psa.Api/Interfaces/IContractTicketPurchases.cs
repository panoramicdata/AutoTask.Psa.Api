...
/// </summary>
public interface IContractTicketPurchases
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractTicketPurchaseModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractTicketPurchaseModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractTicketPurchaseModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
