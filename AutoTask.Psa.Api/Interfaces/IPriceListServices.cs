...
public interface IPriceListServices
{
	...
	Task<PriceListServiceModel> PatchAsync([Body] PriceListServiceModel entity);
	...
	Task<QueryActionResult<PriceListServiceModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<PriceListServiceModel> GetAsync([AliasAs("id")] long id);
	...
	Task<PriceListServiceModel> UpdateAsync([Body] PriceListServiceModel entity);
	...
	Task<QueryActionResult<PriceListServiceModel>> QueryAsync([AliasAs("search")] string search);
