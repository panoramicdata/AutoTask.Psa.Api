...
public interface IPriceListServices
{
	...
	Task<PriceListServiceModel> PatchAsync([Body] PriceListServiceModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<PriceListServiceModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<PriceListServiceModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<PriceListServiceModel> UpdateAsync([Body] PriceListServiceModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<PriceListServiceModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
