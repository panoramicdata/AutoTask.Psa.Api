...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IInvoiceTemplates
	{
		...
		Task<QueryActionResult<InvoiceTemplateModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<InvoiceTemplateModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<InvoiceTemplateModel>> QueryAsync([AliasAs("search")] string search);
