...
/// </summary>
public interface IInvoiceTemplates
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<InvoiceTemplateModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<InvoiceTemplateModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<InvoiceTemplateModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
