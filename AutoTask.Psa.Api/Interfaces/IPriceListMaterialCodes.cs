...
public interface IPriceListMaterialCodes
{
	...
	Task<QueryActionResult<PriceListMaterialCodeModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<QueryActionResult<PriceListMaterialCodeModel>> QueryAsync([AliasAs("search")] string search);
