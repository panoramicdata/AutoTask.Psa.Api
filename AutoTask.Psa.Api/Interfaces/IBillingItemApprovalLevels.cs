...
/// </summary>
public interface IBillingItemApprovalLevels
{
	/// <summary>
	///
	/// </summary>
	...
	Task<BillingItemApprovalLevelModel> CreateAsync([Body] BillingItemApprovalLevelModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<BillingItemApprovalLevelModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<BillingItemApprovalLevelModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<BillingItemApprovalLevelModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
