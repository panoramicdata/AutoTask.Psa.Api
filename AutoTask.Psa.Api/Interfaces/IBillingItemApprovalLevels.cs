...
public interface IBillingItemApprovalLevels
{
	...
	Task<BillingItemApprovalLevelModel> CreateAsync([Body] BillingItemApprovalLevelModel entity);
	...
	Task<QueryActionResult<BillingItemApprovalLevelModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<BillingItemApprovalLevelModel> GetAsync([AliasAs("id")] long id);
