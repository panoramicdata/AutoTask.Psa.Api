...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IBillingItems
	{
		...
		Task<BillingItemModel> PatchAsync([Body] BillingItemModel entity);
		...
		Task<QueryActionResult<BillingItemModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<BillingItemModel> GetAsync([AliasAs("id")] long id);
		...
		Task<BillingItemModel> UpdateAsync([Body] BillingItemModel entity);
		...
		Task<QueryActionResult<BillingItemModel>> QueryAsync([AliasAs("search")] string search);
