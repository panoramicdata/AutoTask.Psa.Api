...
/// </summary>
public interface IContactWebhookUdfFields
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContactWebhookUdfFieldModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContactWebhookUdfFieldModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContactWebhookUdfFieldModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
