...
public interface IServiceCallTicketResourcesChild
{
	...
	Task<ServiceCallTicketResourceModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ServiceCallTicketResourceModel entity, CancellationToken cancellationToken);
