...
public interface IContractServicesChild
{
	...
	Task<ContractServiceModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ContractServiceModel entity, CancellationToken cancellationToken);
	...
	Task<ContractServiceModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] ContractServiceModel entity, CancellationToken cancellationToken);
	...
	Task<ContractServiceModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] ContractServiceModel entity, CancellationToken cancellationToken);
}
