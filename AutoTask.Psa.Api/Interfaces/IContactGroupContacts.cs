...
/// </summary>
public interface IContactGroupContacts
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContactGroupContactModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContactGroupContactModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContactGroupContactModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
