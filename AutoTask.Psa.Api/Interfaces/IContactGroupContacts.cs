...
public interface IContactGroupContacts
{
	...
	Task<QueryActionResult<ContactGroupContactModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContactGroupContactModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContactGroupContactModel>> QueryAsync([AliasAs("search")] string search);
