...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface ITaskNotesApi
	{
		/// <summary>
		///
		/// </summary>
		...
		[Post("/V1.0/TaskNotes")]
		Task<TaskNoteModel> CreateAsync([Body] TaskNoteModel entity);
		...
		Task<TaskNoteModel> PatchAsync([Body] TaskNoteModel entity);
		...
		Task<TaskNoteModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<TaskNoteModel> GetAsync([AliasAs("id")] long id);
		...
		/// <returns>Task of TaskNoteModel</returns>
		[Put("/V1.0/TaskNotes")]
		Task<TaskNoteModel> UpdateAsync([Body] TaskNoteModel entity);
		...
		Task<TaskNoteModel> QueryAsync([AliasAs("search")] string search);
