...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface ITaskNotesChildApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<TaskNoteModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] TaskNoteModel entity);
		...
		Task<TaskNoteModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] TaskNoteModel entity);
		...
		Task<TaskNoteModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] TaskNoteModel entity);
	}
}
