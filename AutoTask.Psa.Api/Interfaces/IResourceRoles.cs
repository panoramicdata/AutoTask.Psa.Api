...
/// </summary>
public interface IResourceRoles
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ResourceRoleModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ResourceRoleModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ResourceRoleModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
