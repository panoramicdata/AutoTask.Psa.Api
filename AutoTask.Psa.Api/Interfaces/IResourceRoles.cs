...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IResourceRoles
	{
		...
		Task<QueryActionResult<ResourceRoleModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ResourceRoleModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<ResourceRoleModel>> QueryAsync([AliasAs("search")] string search);
