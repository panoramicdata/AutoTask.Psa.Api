...
/// </summary>
public interface ICompanyLocations
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<CompanyLocationModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<CompanyLocationModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<CompanyLocationModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
