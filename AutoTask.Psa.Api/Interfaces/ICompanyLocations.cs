...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICompanyLocations
	{
		...
		Task<QueryActionResult<CompanyLocationModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<CompanyLocationModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<CompanyLocationModel>> QueryAsync([AliasAs("search")] string search);
