...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IChangeRequestLinks
	{
		...
		Task<ChangeRequestLinkModel> CreateAsync([Body] ChangeRequestLinkModel entity);
		...
		Task<QueryActionResult<ChangeRequestLinkModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ChangeRequestLinkModel> GetAsync([AliasAs("id")] long id);
