...
public interface IResourceRoleQueues
{
	...
	Task<QueryActionResult<ResourceRoleQueueModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ResourceRoleQueueModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ResourceRoleQueueModel>> QueryAsync([AliasAs("search")] string search);
