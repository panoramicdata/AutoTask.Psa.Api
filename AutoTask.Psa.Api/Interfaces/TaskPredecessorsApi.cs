...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ITaskPredecessorsApi
	{
		...
		Task<TaskPredecessorModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<TaskPredecessorModel> GetAsync([AliasAs("id")] long id);
		...
		Task<TaskPredecessorModel> QueryAsync([AliasAs("search")] string search);
