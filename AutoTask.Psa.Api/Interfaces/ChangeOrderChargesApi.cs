...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface IChangeOrderChargesApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<ChangeOrderChargeModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ChangeOrderChargeModel> QueryAsync([AliasAs("search")] string search);
