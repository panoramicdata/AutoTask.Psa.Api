...
/// </summary>
public interface ICompanyTeamsChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<CompanyTeamModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] CompanyTeamModel entity, CancellationToken cancellationToken);
