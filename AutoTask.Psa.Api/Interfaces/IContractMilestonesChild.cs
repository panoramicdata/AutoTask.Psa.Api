...
/// </summary>
public interface IContractMilestonesChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<ContractMilestoneModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ContractMilestoneModel entity);
	...
	Task<ContractMilestoneModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] ContractMilestoneModel entity);
	...
	Task<ContractMilestoneModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] ContractMilestoneModel entity);
}
