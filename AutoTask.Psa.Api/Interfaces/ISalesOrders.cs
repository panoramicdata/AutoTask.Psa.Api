...
public interface ISalesOrders
{
	...
	Task<SalesOrderModel> PatchAsync([Body] SalesOrderModel entity);
	...
	Task<SalesOrderModel> GetAsync([AliasAs("id")] long id);
	...
	Task<SalesOrderModel> UpdateAsync([Body] SalesOrderModel entity);
	...
	Task<QueryActionResult<SalesOrderModel>> QueryAsync([AliasAs("search")] string search);
