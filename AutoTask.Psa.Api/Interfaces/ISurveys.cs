...
public interface ISurveys
{
	...
	Task<QueryActionResult<SurveyModel>> QueryAsync([Body] QueryModel queryModel);
	...
	/// <returns>Task of SurveyModel</returns>
	[Get("/V1.0/Surveys/{id}")]
	Task<SurveyModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<SurveyModel>> QueryAsync([AliasAs("search")] string search);
