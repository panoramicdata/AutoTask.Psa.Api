...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface IResourceRolesChildApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<ResourceRoleModel> QueryAsync([AliasAs("parentId")] long? parentId);
		...
		Task<ResourceRoleModel> GetAsync([AliasAs("parentId")] long? parentId, [AliasAs("id")] long? id);
