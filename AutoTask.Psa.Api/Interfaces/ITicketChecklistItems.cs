...
/// </summary>
public interface ITicketChecklistItems
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<TicketChecklistItemModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<TicketChecklistItemModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<TicketChecklistItemModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
