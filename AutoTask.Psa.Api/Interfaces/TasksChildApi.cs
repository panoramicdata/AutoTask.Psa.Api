...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface ITasksChildApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<TaskModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] TaskModel entity);
		...
		Task<TaskModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] TaskModel entity);
		...
		Task<TaskModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] TaskModel entity);
	}
}
