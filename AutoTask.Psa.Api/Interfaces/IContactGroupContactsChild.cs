...
/// </summary>
public interface IContactGroupContactsChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<ContactGroupContactModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ContactGroupContactModel entity, CancellationToken cancellationToken);
	...
	Task<ContactGroupContactModel> QueryAsync([AliasAs("parentId")] long? parentId);
	...
	Task<ContactGroupContactModel> GetAsync([AliasAs("parentId")] long? parentId, [AliasAs("id")] long? id);
