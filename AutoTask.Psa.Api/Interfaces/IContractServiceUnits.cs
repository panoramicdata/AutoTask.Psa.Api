...
public interface IContractServiceUnits
{
	...
	Task<QueryActionResult<ContractServiceUnitModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContractServiceUnitModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContractServiceUnitModel>> QueryAsync([AliasAs("search")] string search);
