...
/// </summary>
public interface IContractServiceUnits
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractServiceUnitModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractServiceUnitModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractServiceUnitModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
