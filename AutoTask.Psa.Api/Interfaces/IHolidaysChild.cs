...
public interface IHolidaysChild
{
	...
	Task<HolidayModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] HolidayModel entity, CancellationToken cancellationToken);
	...
	Task<HolidayModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] HolidayModel entity, CancellationToken cancellationToken);
	...
	Task<HolidayModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] HolidayModel entity, CancellationToken cancellationToken);
}
