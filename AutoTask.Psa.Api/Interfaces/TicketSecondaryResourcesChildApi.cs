...
/// </summary>
public interface ITicketSecondaryResourcesChildApi
{
	/// <summary>
	///
	/// </summary>
	...
	Task<TicketSecondaryResourceModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] TicketSecondaryResourceModel entity);
