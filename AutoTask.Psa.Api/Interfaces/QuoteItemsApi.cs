...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IQuoteItemsApi
	{
		...
		Task<QuoteItemModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<QuoteItemModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QuoteItemModel> QueryAsync([AliasAs("search")] string search);
