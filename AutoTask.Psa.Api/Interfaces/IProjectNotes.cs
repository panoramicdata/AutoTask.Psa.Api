...
public interface IProjectNotes
{
	...
	Task<QueryActionResult<ProjectNoteModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ProjectNoteModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ProjectNoteModel>> QueryAsync([AliasAs("search")] string search);
