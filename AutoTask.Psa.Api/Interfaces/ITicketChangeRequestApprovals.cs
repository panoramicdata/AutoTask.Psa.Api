...
public interface ITicketChangeRequestApprovals
{
	...
	Task<TicketChangeRequestApprovalModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<TicketChangeRequestApprovalModel>> QueryAsync([AliasAs("search")] string search);
