...
/// </summary>
public interface ITicketChangeRequestApprovals
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<TicketChangeRequestApprovalModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<TicketChangeRequestApprovalModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<TicketChangeRequestApprovalModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
