...
/// </summary>
public interface IProjectChargesChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<ProjectChargeModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ProjectChargeModel entity, CancellationToken cancellationToken);
	...
	Task<ProjectChargeModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] ProjectChargeModel entity, CancellationToken cancellationToken);
	...
	Task<ProjectChargeModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] ProjectChargeModel entity, CancellationToken cancellationToken);
}
