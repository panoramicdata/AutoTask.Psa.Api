...
/// </summary>
public interface ICompanyAlerts
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<CompanyAlertModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<CompanyAlertModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<CompanyAlertModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
