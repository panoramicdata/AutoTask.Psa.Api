...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICompanyAlerts
	{
		...
		Task<QueryActionResult<CompanyAlertModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<CompanyAlertModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<CompanyAlertModel>> QueryAsync([AliasAs("search")] string search);
