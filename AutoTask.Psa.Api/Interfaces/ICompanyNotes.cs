...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICompanyNotes
	{
		...
		Task<QueryActionResult<CompanyNoteModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<CompanyNoteModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<CompanyNoteModel>> QueryAsync([AliasAs("search")] string search);
