...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IServiceCallTaskResourcesApi
	{
		...
		Task<ServiceCallTaskResourceModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ServiceCallTaskResourceModel> GetAsync([AliasAs("id")] long id);
		...
		Task<ServiceCallTaskResourceModel> StringQueryAsync([AliasAs("search")] string search);
