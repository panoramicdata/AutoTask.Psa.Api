...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IConfigurationItemCategoryUdfAssociationsApi
	{
		...
		Task<ConfigurationItemCategoryUdfAssociationModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ConfigurationItemCategoryUdfAssociationModel> GetAsync([AliasAs("id")] long id);
		...
		Task<ConfigurationItemCategoryUdfAssociationModel> StringQueryAsync([AliasAs("search")] string search);
