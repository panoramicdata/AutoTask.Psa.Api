...
public interface ICountries
{
	...
	Task<CountryModel> PatchAsync([Body] CountryModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<CountryModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<CountryModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	/// <returns>Task of CountryModel</returns>
	[Put("/V1.0/Countries")]
	Task<CountryModel> UpdateAsync([Body] CountryModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<CountryModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
