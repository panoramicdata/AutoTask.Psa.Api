...
public interface ICompanyWebhookExcludedResources
{
	...
	Task<QueryActionResult<CompanyWebhookExcludedResourceModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<QueryActionResult<CompanyWebhookExcludedResourceModel>> QueryAsync([AliasAs("search")] string search);
