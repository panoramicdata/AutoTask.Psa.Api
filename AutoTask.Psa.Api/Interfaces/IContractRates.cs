...
/// </summary>
public interface IContractRates
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractRateModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractRateModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractRateModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
