...
/// </summary>
public interface IProjectAttachments
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ProjectAttachmentModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ProjectAttachmentModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ProjectAttachmentModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
