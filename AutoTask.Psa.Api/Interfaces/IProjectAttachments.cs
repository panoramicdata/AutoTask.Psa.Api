...
public interface IProjectAttachments
{
	...
	Task<QueryActionResult<ProjectAttachmentModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ProjectAttachmentModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ProjectAttachmentModel>> QueryAsync([AliasAs("search")] string search);
