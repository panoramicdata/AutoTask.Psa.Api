...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IContractExclusionBillingCodesApi
	{
		...
		Task<ContractExclusionBillingCodeModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ContractExclusionBillingCodeModel> GetAsync([AliasAs("id")] long id);
		...
		Task<ContractExclusionBillingCodeModel> QueryAsync([AliasAs("search")] string search);
