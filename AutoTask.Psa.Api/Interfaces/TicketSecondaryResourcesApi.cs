...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ITicketSecondaryResourcesApi
	{
		...
		Task<TicketSecondaryResourceModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<TicketSecondaryResourceModel> GetAsync([AliasAs("id")] long id);
		...
		Task<TicketSecondaryResourceModel> QueryAsync([AliasAs("search")] string search);
