...
public interface ICompanyWebhookFieldsChild
{
	...
	Task<CompanyWebhookFieldModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] CompanyWebhookFieldModel entity, CancellationToken cancellationToken);
	...
	Task<CompanyWebhookFieldModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] CompanyWebhookFieldModel entity, CancellationToken cancellationToken);
	...
	Task<CompanyWebhookFieldModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] CompanyWebhookFieldModel entity, CancellationToken cancellationToken);
}
