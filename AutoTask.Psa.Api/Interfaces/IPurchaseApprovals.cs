...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface IPurchaseApprovals
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<PurchaseApprovalModel> PatchAsync([Body] PurchaseApprovalModel entity);
		...
		Task<QueryActionResult<PurchaseApprovalModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<PurchaseApprovalModel> GetAsync([AliasAs("id")] long id);
		...
		Task<PurchaseApprovalModel> UpdateAsync([Body] PurchaseApprovalModel entity);
		...
		Task<QueryActionResult<PurchaseApprovalModel>> QueryAsync([AliasAs("search")] string search);
