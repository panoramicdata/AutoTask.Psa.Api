...
public interface IServiceCallTaskResources
{
	...
	Task<QueryActionResult<ServiceCallTaskResourceModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<QueryActionResult<ServiceCallTaskResourceModel>> QueryAsync([AliasAs("search")] string search);
