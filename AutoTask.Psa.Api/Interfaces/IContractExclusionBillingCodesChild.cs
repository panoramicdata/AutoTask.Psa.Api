...
/// </summary>
public interface IContractExclusionBillingCodesChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<ContractExclusionBillingCodeModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ContractExclusionBillingCodeModel entity, CancellationToken cancellationToken);
