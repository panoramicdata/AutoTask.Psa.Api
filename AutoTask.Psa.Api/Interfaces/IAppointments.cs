...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IAppointments
	{
		...
		Task<AppointmentModel> CreateAsync([Body] AppointmentModel entity);
		...
		Task<AppointmentModel> PatchAsync([Body] AppointmentModel entity);
		...
		Task<QueryActionResult<AppointmentModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<AppointmentModel> GetAsync([AliasAs("id")] long id);
		...
		Task<AppointmentModel> UpdateAsync([Body] AppointmentModel entity);
