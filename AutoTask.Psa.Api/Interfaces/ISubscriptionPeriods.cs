...
public interface ISubscriptionPeriods
{
	...
	Task<QueryActionResult<SubscriptionPeriodModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<SubscriptionPeriodModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<SubscriptionPeriodModel>> QueryAsync([AliasAs("search")] string search);
