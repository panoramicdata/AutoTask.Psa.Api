...
/// </summary>
public interface ISubscriptionPeriods
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<SubscriptionPeriodModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<SubscriptionPeriodModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<SubscriptionPeriodModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
