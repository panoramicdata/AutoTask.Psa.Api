...
public interface IContractRoleCosts
{
	...
	Task<QueryActionResult<ContractRoleCostModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContractRoleCostModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContractRoleCostModel>> QueryAsync([AliasAs("search")] string search);
