...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IQuotes
	{
		...
		[Post("/V1.0/Quotes")]
		Task<QuoteModel> CreateAsync([Body] QuoteModel entity);
		...
		/// <returns>Task of QuoteModel</returns>
		[Patch("/V1.0/Quotes")]
		Task<QuoteModel> PatchAsync([Body] QuoteModel entity);
		...
		/// <returns>Task of QuoteModel</returns>
		[Get("/V1.0/Quotes/{id}")]
		Task<QuoteModel> GetAsync([AliasAs("id")] long id);
		...
		/// <returns>Task of QuoteModel</returns>
		[Put("/V1.0/Quotes")]
		Task<QuoteModel> UpdateAsync([Body] QuoteModel entity);
		...
		Task<QueryActionResult<QuoteModel>> QueryAsync([AliasAs("search")] string search);
