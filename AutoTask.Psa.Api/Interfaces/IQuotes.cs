...
public interface IQuotes
{
	...
	[Post("/V1.0/Quotes")]
	Task<QuoteModel> CreateAsync([Body] QuoteModel entity, CancellationToken cancellationToken);
	...
	/// <returns>Task of QuoteModel</returns>
	[Patch("/V1.0/Quotes")]
	Task<QuoteModel> PatchAsync([Body] QuoteModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<QuoteModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	/// <returns>Task of QuoteModel</returns>
	[Get("/V1.0/Quotes/{id}")]
	Task<QuoteModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	/// <returns>Task of QuoteModel</returns>
	[Put("/V1.0/Quotes")]
	Task<QuoteModel> UpdateAsync([Body] QuoteModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<QuoteModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
