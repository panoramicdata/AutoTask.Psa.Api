...
public interface IContactWebhookFields
{
	...
	Task<QueryActionResult<ContactWebhookFieldModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContactWebhookFieldModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContactWebhookFieldModel>> QueryAsync([AliasAs("search")] string search);
