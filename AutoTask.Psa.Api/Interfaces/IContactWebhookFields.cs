...
/// </summary>
public interface IContactWebhookFields
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContactWebhookFieldModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContactWebhookFieldModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContactWebhookFieldModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
