...
public interface ISkills
{
	...
	Task<QueryActionResult<SkillModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	/// <returns>Task of SkillModel</returns>
	[Get("/V1.0/Skills/{id}")]
	Task<SkillModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<SkillModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
