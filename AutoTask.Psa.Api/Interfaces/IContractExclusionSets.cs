...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IContractExclusionSets
	{
		...
		Task<ContractExclusionSetModel> CreateAsync([Body] ContractExclusionSetModel entity);
		...
		Task<ContractExclusionSetModel> PatchAsync([Body] ContractExclusionSetModel entity);
		...
		Task<QueryActionResult<ContractExclusionSetModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ContractExclusionSetModel> GetAsync([AliasAs("id")] long id);
		...
		Task<ContractExclusionSetModel> UpdateAsync([Body] ContractExclusionSetModel entity);
		...
		Task<QueryActionResult<ContractExclusionSetModel>> QueryAsync([AliasAs("search")] string search);
