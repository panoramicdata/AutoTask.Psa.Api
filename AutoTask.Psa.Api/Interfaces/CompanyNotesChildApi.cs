...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICompanyNotesChildApi
	{
		...
		Task<CompanyNoteModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] CompanyNoteModel entity);
		...
		Task<CompanyNoteModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] CompanyNoteModel entity);
		...
		Task<CompanyNoteModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] CompanyNoteModel entity);
	}
}
