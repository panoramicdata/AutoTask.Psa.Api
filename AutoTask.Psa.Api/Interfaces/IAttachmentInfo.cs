...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IAttachmentInfoApi
	{
		...
		Task<AttachmentInfoModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<AttachmentInfoModel> GetAsync([AliasAs("id")] long id);
		...
		Task<AttachmentInfoModel> StringQueryAsync([AliasAs("search")] string search);
