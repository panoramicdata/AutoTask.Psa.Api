...
public interface IContractServices
{
	...
	Task<QueryActionResult<ContractServiceModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<QueryActionResult<ContractServiceModel>> QueryAsync([AliasAs("search")] string search);
