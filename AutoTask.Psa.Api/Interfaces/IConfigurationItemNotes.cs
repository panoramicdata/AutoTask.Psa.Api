...
/// </summary>
public interface IConfigurationItemNotes
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ConfigurationItemNoteModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ConfigurationItemNoteModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ConfigurationItemNoteModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
