...
public interface IServiceBundles
{
	...
	Task<ServiceBundleModel> CreateAsync([Body] ServiceBundleModel entity, CancellationToken cancellationToken);
	...
	Task<ServiceBundleModel> PatchAsync([Body] ServiceBundleModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ServiceBundleModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ServiceBundleModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<ServiceBundleModel> UpdateAsync([Body] ServiceBundleModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ServiceBundleModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
