...
/// </summary>
public interface IContactWebhookUdfFieldsChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<ContactWebhookUdfFieldModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ContactWebhookUdfFieldModel entity, CancellationToken cancellationToken);
	...
	Task<ContactWebhookUdfFieldModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] ContactWebhookUdfFieldModel entity, CancellationToken cancellationToken);
	...
	Task<ContactWebhookUdfFieldModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] ContactWebhookUdfFieldModel entity, CancellationToken cancellationToken);
}
