...
/// </summary>
public interface IConfigurationItemCategories
{
	/// <summary>
	///
	/// </summary>
	...
	Task<ConfigurationItemCategoryModel> CreateAsync([Body] ConfigurationItemCategoryModel entity, CancellationToken cancellationToken);
	...
	Task<ConfigurationItemCategoryModel> PatchAsync([Body] ConfigurationItemCategoryModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ConfigurationItemCategoryModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ConfigurationItemCategoryModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<ConfigurationItemCategoryModel> UpdateAsync([Body] ConfigurationItemCategoryModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ConfigurationItemCategoryModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
