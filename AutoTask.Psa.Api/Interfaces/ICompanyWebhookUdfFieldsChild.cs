...
public interface ICompanyWebhookUdfFieldsChild
{
	...
	Task<CompanyWebhookUdfFieldModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] CompanyWebhookUdfFieldModel entity, CancellationToken cancellationToken);
	...
	Task<CompanyWebhookUdfFieldModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] CompanyWebhookUdfFieldModel entity, CancellationToken cancellationToken);
	...
	Task<CompanyWebhookUdfFieldModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] CompanyWebhookUdfFieldModel entity, CancellationToken cancellationToken);
}
