...
public interface IServiceLevelAgreementResults
{
	...
	Task<QueryActionResult<ServiceLevelAgreementResultsModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ServiceLevelAgreementResultsModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ServiceLevelAgreementResultsModel>> QueryAsync([AliasAs("search")] string search);
