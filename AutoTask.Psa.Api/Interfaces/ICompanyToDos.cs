...
public interface ICompanyToDos
{
	...
	Task<QueryActionResult<CompanyToDoModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<CompanyToDoModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<CompanyToDoModel>> QueryAsync([AliasAs("search")] string search);
