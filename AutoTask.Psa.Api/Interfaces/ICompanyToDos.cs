...
/// </summary>
public interface ICompanyToDos
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<CompanyToDoModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<CompanyToDoModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<CompanyToDoModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
