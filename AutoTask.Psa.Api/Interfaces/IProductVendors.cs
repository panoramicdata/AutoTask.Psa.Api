...
public interface IProductVendors
{
	...
	Task<QueryActionResult<ProductVendorModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ProductVendorModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ProductVendorModel>> QueryAsync([AliasAs("search")] string search);
