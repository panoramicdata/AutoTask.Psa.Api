...
/// </summary>
public interface IProductVendors
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ProductVendorModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ProductVendorModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ProductVendorModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
