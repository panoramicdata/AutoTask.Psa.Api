...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface IContractTicketPurchasesApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<ContractTicketPurchaseModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ContractTicketPurchaseModel> GetAsync([AliasAs("id")] long id);
		...
		Task<ContractTicketPurchaseModel> QueryAsync([AliasAs("search")] string search);
