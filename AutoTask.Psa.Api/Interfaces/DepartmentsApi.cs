...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IDepartmentsApi
	{
		...
		Task<DepartmentModel> CreateAsync([Body] DepartmentModel entity);
		...
		Task<DepartmentModel> PatchAsync([Body] DepartmentModel entity);
		...
		Task<DepartmentModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<DepartmentModel> GetAsync([AliasAs("id")] long id);
		...
		Task<DepartmentModel> UpdateAsync([Body] DepartmentModel entity);
		...
		Task<DepartmentModel> QueryAsync([AliasAs("search")] string search);
