...
public interface IContractServiceBundleUnits
{
	...
	Task<QueryActionResult<ContractServiceBundleUnitModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContractServiceBundleUnitModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContractServiceBundleUnitModel>> QueryAsync([AliasAs("search")] string search);
