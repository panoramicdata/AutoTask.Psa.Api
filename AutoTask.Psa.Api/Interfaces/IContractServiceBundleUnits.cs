...
/// </summary>
public interface IContractServiceBundleUnits
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractServiceBundleUnitModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractServiceBundleUnitModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractServiceBundleUnitModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
