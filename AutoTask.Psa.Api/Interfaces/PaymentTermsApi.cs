...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface IPaymentTermsApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<PaymentTermModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<PaymentTermModel> QueryAsync([AliasAs("search")] string search);
