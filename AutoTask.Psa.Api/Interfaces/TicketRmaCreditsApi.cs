...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ITicketRmaCreditsApi
	{
		...
		Task<TicketRmaCreditModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<TicketRmaCreditModel> GetAsync([AliasAs("id")] long id);
		...
		Task<TicketRmaCreditModel> QueryAsync([AliasAs("search")] string search);
