...
public interface IExpenseReports
{
	...
	Task<QueryActionResult<ExpenseReportModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<QueryActionResult<ExpenseReportModel>> QueryAsync([AliasAs("search")] string search);
