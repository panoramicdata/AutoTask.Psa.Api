...
public interface ITaskSecondaryResources
{
	...
	Task<QueryActionResult<TaskSecondaryResourceModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<TaskSecondaryResourceModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<TaskSecondaryResourceModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
