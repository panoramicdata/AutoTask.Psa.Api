...
public interface ICompanySiteConfigurations
{
	...
	Task<QueryActionResult<CompanySiteConfigurationModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<QueryActionResult<CompanySiteConfigurationModel>> QueryAsync([AliasAs("search")] string search);
