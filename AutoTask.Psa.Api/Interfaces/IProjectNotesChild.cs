...
public interface IProjectNotesChild
{
	...
	Task<ProjectNoteModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ProjectNoteModel entity, CancellationToken cancellationToken);
	...
	Task<ProjectNoteModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] ProjectNoteModel entity, CancellationToken cancellationToken);
	...
	Task<ProjectNoteModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] ProjectNoteModel entity, CancellationToken cancellationToken);
}
