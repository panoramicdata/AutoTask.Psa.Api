...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICompanyWebhookExcludedResourcesApi
	{
		...
		Task<CompanyWebhookExcludedResourceModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<CompanyWebhookExcludedResourceModel> GetAsync([AliasAs("id")] long id);
		...
		Task<CompanyWebhookExcludedResourceModel> StringQueryAsync([AliasAs("search")] string search);
