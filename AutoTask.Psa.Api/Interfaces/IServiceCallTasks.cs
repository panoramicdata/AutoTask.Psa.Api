...
public interface IServiceCallTasks
{
	...
	Task<QueryActionResult<ServiceCallTaskModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ServiceCallTaskModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ServiceCallTaskModel>> QueryAsync([AliasAs("search")] string search);
