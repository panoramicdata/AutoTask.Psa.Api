...
/// </summary>
public interface IServiceCallTasks
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ServiceCallTaskModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ServiceCallTaskModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ServiceCallTaskModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
