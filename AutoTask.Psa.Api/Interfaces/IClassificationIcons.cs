...
/// </summary>
public interface IClassificationIcons
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ClassificationIconModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ClassificationIconModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ClassificationIconModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
