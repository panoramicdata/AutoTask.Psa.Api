...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IConfigurationItemCategoryUdfAssociations
	{
		...
		Task<QueryActionResult<ConfigurationItemCategoryUdfAssociationModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<QueryActionResult<ConfigurationItemCategoryUdfAssociationModel>> QueryAsync([AliasAs("search")] string search);
