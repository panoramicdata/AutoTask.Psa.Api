...
/// </summary>
public interface IContractBlocks
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractBlockModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractBlockModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractBlockModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
