...
public interface IContractBlocks
{
	...
	Task<QueryActionResult<ContractBlockModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContractBlockModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContractBlockModel>> QueryAsync([AliasAs("search")] string search);
