...
/// </summary>
public interface ITicketChecklistLibraries
{
	/// <summary>
	///
	/// </summary>
	...
	Task<TicketChecklistLibraryModel> CreateAsync([Body] TicketChecklistLibraryModel entity, CancellationToken cancellationToken);
