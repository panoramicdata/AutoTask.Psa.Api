...
public interface ICompanyAttachments
{
	...
	Task<QueryActionResult<CompanyAttachmentModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<CompanyAttachmentModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<CompanyAttachmentModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
