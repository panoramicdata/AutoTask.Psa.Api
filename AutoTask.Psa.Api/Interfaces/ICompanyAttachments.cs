...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICompanyAttachments
	{
		...
		Task<QueryActionResult<CompanyAttachmentModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<QueryActionResult<CompanyAttachmentModel>> QueryAsync([AliasAs("search")] string search);
