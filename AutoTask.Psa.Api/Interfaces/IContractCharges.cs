...
/// </summary>
public interface IContractCharges
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractChargeModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractChargeModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractChargeModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
