...
/// </summary>
public interface IQuoteItemsChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QuoteItemModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] QuoteItemModel entity, CancellationToken cancellationToken);
	...
	Task<QuoteItemModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] QuoteItemModel entity, CancellationToken cancellationToken);
	...
	Task<QuoteItemModel> QueryAsync([AliasAs("parentId")] long? parentId);
	...
	Task<QuoteItemModel> GetAsync([AliasAs("parentId")] long? parentId, [AliasAs("id")] long? id);
	...
	Task<QuoteItemModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] QuoteItemModel entity, CancellationToken cancellationToken);
}
