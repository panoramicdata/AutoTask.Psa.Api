...
public interface IContractServiceUnitsChildApi
{
	...
	Task<ContractServiceUnitModel> QueryAsync([AliasAs("parentId")] long? parentId);
	...
	Task<ContractServiceUnitModel> GetAsync([AliasAs("parentId")] long? parentId, [AliasAs("id")] long? id);
