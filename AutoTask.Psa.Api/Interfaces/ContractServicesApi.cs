...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IContractServicesApi
	{
		...
		Task<ContractServiceModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ContractServiceModel> GetAsync([AliasAs("id")] long id);
		...
		Task<ContractServiceModel> StringQueryAsync([AliasAs("search")] string search);
