...
public interface IPriceListRoles
{
	...
	Task<PriceListRoleModel> PatchAsync([Body] PriceListRoleModel entity);
	...
	Task<QueryActionResult<PriceListRoleModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<PriceListRoleModel> GetAsync([AliasAs("id")] long id);
	...
	Task<PriceListRoleModel> UpdateAsync([Body] PriceListRoleModel entity);
