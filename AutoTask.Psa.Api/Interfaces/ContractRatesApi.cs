...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IContractRatesApi
	{
		...
		Task<ContractRateModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ContractRateModel> GetAsync([AliasAs("id")] long id);
		...
		Task<ContractRateModel> QueryAsync([AliasAs("search")] string search);
