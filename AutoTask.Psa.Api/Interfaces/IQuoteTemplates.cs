...
/// </summary>
public interface IQuoteTemplates
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<QuoteTemplateModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<QuoteTemplateModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<QuoteTemplateModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
