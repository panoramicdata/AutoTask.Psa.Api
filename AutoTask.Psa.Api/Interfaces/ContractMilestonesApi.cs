...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IContractMilestonesApi
	{
		...
		Task<ContractMilestoneModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ContractMilestoneModel> GetAsync([AliasAs("id")] long id);
		...
		Task<ContractMilestoneModel> QueryAsync([AliasAs("search")] string search);
