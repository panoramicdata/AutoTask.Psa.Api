...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface ITaskSecondaryResourcesChildApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<TaskSecondaryResourceModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] TaskSecondaryResourceModel entity);
