...
/// </summary>
public interface ITicketAdditionalConfigurationItemsChildApi
{
	/// <summary>
	///
	/// </summary>
	...
	Task<TicketAdditionalConfigurationItemModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] TicketAdditionalConfigurationItemModel entity);
