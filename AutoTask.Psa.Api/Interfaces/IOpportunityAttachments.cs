...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IOpportunityAttachments
	{
		...
		Task<QueryActionResult<OpportunityAttachmentModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<OpportunityAttachmentModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<OpportunityAttachmentModel>> QueryAsync([AliasAs("search")] string search);
