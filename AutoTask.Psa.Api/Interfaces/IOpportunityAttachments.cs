...
/// </summary>
public interface IOpportunityAttachments
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<OpportunityAttachmentModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<OpportunityAttachmentModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<OpportunityAttachmentModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
