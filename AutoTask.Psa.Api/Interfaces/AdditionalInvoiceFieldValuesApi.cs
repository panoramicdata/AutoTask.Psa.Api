...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IAdditionalInvoiceFieldValuesApi
	{
		...
		Task<AdditionalInvoiceFieldValueModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<AdditionalInvoiceFieldValueModel> StringQueryAsync([AliasAs("search")] string search);
