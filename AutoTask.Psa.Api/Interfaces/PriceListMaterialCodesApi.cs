...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IPriceListMaterialCodesApi
	{
		...
		Task<PriceListMaterialCodeModel> PatchAsync([Body] PriceListMaterialCodeModel entity);
		...
		Task<PriceListMaterialCodeModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<PriceListMaterialCodeModel> GetAsync([AliasAs("id")] long id);
		...
		Task<PriceListMaterialCodeModel> UpdateAsync([Body] PriceListMaterialCodeModel entity);
		...
		Task<PriceListMaterialCodeModel> StringQueryAsync([AliasAs("search")] string search);
