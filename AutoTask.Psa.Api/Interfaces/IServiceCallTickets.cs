...
/// </summary>
public interface IServiceCallTickets
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ServiceCallTicketModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ServiceCallTicketModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ServiceCallTicketModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
