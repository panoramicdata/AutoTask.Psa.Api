...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IInternalLocationsApi
	{
		...
		Task<InternalLocationModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<InternalLocationModel> GetAsync([AliasAs("id")] long id);
		...
		Task<InternalLocationModel> QueryAsync([AliasAs("search")] string search);
