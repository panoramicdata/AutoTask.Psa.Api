...
public interface ITicketChargesChildApi
{
	...
	Task<TicketChargeModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] TicketChargeModel entity);
	...
	Task<TicketChargeModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] TicketChargeModel entity);
	...
	Task<TicketChargeModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] TicketChargeModel entity);
}
