...
/// </summary>
public interface IComanagedAssociations
{
	/// <summary>
	///
	/// </summary>
	...
	Task<ComanagedAssociationModel> CreateAsync([Body] ComanagedAssociationModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ComanagedAssociationModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ComanagedAssociationModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ComanagedAssociationModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
