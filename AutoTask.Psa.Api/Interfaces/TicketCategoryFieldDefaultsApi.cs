...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ITicketCategoryFieldDefaultsApi
	{
		...
		Task<TicketCategoryFieldDefaultsModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<TicketCategoryFieldDefaultsModel> StringQueryAsync([AliasAs("search")] string search);
