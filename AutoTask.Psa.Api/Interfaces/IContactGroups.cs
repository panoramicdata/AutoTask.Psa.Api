...
public interface IContactGroups
{
	...
	Task<ContactGroupModel> CreateAsync([Body] ContactGroupModel entity);
	...
	Task<ContactGroupModel> PatchAsync([Body] ContactGroupModel entity);
	...
	Task<QueryActionResult<ContactGroupModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContactGroupModel> GetAsync([AliasAs("id")] long id);
	...
	Task<ContactGroupModel> UpdateAsync([Body] ContactGroupModel entity);
	...
	Task<QueryActionResult<ContactGroupModel>> QueryAsync([AliasAs("search")] string search);
