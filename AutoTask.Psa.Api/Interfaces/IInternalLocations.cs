...
/// </summary>
public interface IInternalLocations
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<InternalLocationModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<InternalLocationModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<InternalLocationModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
