...
/// </summary>
public interface IInventoryTransfers
{
	/// <summary>
	///
	/// </summary>
	...
	Task<InventoryTransferModel> CreateAsync([Body] InventoryTransferModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<InventoryTransferModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<InventoryTransferModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<InventoryTransferModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
