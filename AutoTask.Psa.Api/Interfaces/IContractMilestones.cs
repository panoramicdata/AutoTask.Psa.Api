...
/// </summary>
public interface IContractMilestones
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractMilestoneModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractMilestoneModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractMilestoneModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
