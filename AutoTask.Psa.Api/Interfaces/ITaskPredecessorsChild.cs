...
/// </summary>
public interface ITaskPredecessorsChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<TaskPredecessorModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] TaskPredecessorModel entity, CancellationToken cancellationToken);
	...
	Task<TaskPredecessorModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] TaskPredecessorModel entity, CancellationToken cancellationToken);
	...
	Task<TaskPredecessorModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] TaskPredecessorModel entity, CancellationToken cancellationToken);
}
