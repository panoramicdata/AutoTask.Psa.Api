...
/// </summary>
public interface ITicketAdditionalContactsChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<TicketAdditionalContactModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] TicketAdditionalContactModel entity, CancellationToken cancellationToken);
	...
	Task<TicketAdditionalContactModel> QueryAsync([AliasAs("parentId")] long? parentId);
	...
	Task<TicketAdditionalContactModel> GetAsync([AliasAs("parentId")] long? parentId, [AliasAs("id")] long? id);
