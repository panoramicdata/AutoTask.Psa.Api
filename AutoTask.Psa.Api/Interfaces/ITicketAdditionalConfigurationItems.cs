...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ITicketAdditionalConfigurationItems
	{
		...
		Task<QueryActionResult<TicketAdditionalConfigurationItemModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<TicketAdditionalConfigurationItemModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<TicketAdditionalConfigurationItemModel>> QueryAsync([AliasAs("search")] string search);
