...
/// </summary>
public interface ITaskPredecessors
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<TaskPredecessorModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<TaskPredecessorModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<TaskPredecessorModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
