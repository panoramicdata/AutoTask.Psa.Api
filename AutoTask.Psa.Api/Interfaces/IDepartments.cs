...
public interface IDepartments
{
	...
	Task<DepartmentModel> CreateAsync([Body] DepartmentModel entity, CancellationToken cancellationToken);
	...
	Task<DepartmentModel> PatchAsync([Body] DepartmentModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<DepartmentModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<DepartmentModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<DepartmentModel> UpdateAsync([Body] DepartmentModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<DepartmentModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
