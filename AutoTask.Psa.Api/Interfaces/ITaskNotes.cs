...
public interface ITaskNotes
{
	...
	[Post("/V1.0/TaskNotes")]
	Task<TaskNoteModel> CreateAsync([Body] TaskNoteModel entity, CancellationToken cancellationToken);
	...
	Task<TaskNoteModel> PatchAsync([Body] TaskNoteModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<TaskNoteModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<TaskNoteModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	/// <returns>Task of TaskNoteModel</returns>
	[Put("/V1.0/TaskNotes")]
	Task<TaskNoteModel> UpdateAsync([Body] TaskNoteModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<TaskNoteModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
