...
/// </summary>
public interface IPurchaseOrderItemReceivingApi
{
	/// <summary>
	///
	/// </summary>
	...
	Task<PurchaseOrderItemReceivingModel> QueryAsync([Body] QueryModel queryModel);
	...
	Task<PurchaseOrderItemReceivingModel> GetAsync([AliasAs("id")] long id);
	...
	Task<PurchaseOrderItemReceivingModel> StringQueryAsync([AliasAs("search")] string search);
