...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ITicketHistory
	{
		...
		Task<QueryActionResult<TicketHistoryModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<TicketHistoryModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<TicketHistoryModel>> QueryAsync([AliasAs("search")] string search);
