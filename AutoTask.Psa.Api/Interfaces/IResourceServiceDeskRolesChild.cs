...
/// </summary>
public interface IResourceServiceDeskRolesChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<ResourceServiceDeskRoleModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ResourceServiceDeskRoleModel entity, CancellationToken cancellationToken);
	...
	Task<ResourceServiceDeskRoleModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] ResourceServiceDeskRoleModel entity, CancellationToken cancellationToken);
	...
	Task<ResourceServiceDeskRoleModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] ResourceServiceDeskRoleModel entity, CancellationToken cancellationToken);
}
