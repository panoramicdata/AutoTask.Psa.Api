...
/// </summary>
public interface IContactWebhookFieldsChild
{
	/// <summary>
	///
	/// </summary>
	...
	Task<ContactWebhookFieldModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ContactWebhookFieldModel entity, CancellationToken cancellationToken);
	...
	Task<ContactWebhookFieldModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] ContactWebhookFieldModel entity, CancellationToken cancellationToken);
	...
	Task<ContactWebhookFieldModel> QueryAsync([AliasAs("parentId")] long? parentId);
	...
	Task<ContactWebhookFieldModel> GetAsync([AliasAs("parentId")] long? parentId, [AliasAs("id")] long? id);
	...
	Task<ContactWebhookFieldModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] ContactWebhookFieldModel entity, CancellationToken cancellationToken);
}
