...
public interface IPriceListServiceBundles
{
	...
	Task<QueryActionResult<PriceListServiceBundleModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<QueryActionResult<PriceListServiceBundleModel>> QueryAsync([AliasAs("search")] string search);
