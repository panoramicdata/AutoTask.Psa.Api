...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface IConfigurationItemsApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<ConfigurationItemModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ConfigurationItemModel> StringQueryAsync([AliasAs("search")] string search);
