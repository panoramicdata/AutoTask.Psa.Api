...
public interface IConfigurationItems
{
	...
	Task<ConfigurationItemModel> CreateAsync([Body] ConfigurationItemModel entity, CancellationToken cancellationToken);
	...
	Task<ConfigurationItemModel> PatchAsync([Body] ConfigurationItemModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ConfigurationItemModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ConfigurationItemModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<ConfigurationItemModel> UpdateAsync([Body] ConfigurationItemModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ConfigurationItemModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
