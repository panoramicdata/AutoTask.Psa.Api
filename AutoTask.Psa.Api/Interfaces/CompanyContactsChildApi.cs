...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICompanyContactsChildApi
	{
		...
		Task<ContactModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ContactModel entity);
		...
		Task<ContactModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] ContactModel entity);
		...
		Task<ContactModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] ContactModel entity);
	}
}
