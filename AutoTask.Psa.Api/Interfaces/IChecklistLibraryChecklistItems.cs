...
public interface IChecklistLibraryChecklistItems
{
	...
	Task<QueryActionResult<ChecklistLibraryChecklistItemModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ChecklistLibraryChecklistItemModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ChecklistLibraryChecklistItemModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
