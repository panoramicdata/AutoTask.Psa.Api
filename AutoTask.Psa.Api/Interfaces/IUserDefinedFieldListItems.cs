...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IUserDefinedFieldListItems
	{
		...
		Task<UserDefinedFieldListItemModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<UserDefinedFieldListItemModel>> QueryAsync([AliasAs("search")] string search);
