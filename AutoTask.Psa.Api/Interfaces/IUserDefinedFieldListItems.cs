...
/// </summary>
public interface IUserDefinedFieldListItems
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<UserDefinedFieldListItemModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<UserDefinedFieldListItemModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<UserDefinedFieldListItemModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
