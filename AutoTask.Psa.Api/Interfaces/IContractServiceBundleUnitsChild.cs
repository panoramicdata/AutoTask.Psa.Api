...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface IContractServiceBundleUnitsChild
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<ContractServiceBundleUnitModel> QueryAsync([AliasAs("parentId")] long? parentId);
		...
		Task<ContractServiceBundleUnitModel> GetAsync([AliasAs("parentId")] long? parentId, [AliasAs("id")] long? id);
