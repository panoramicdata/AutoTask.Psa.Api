...
public interface IOrganizationalLevel2
{
	...
	Task<OrganizationalLevel2Model> CreateAsync([Body] OrganizationalLevel2Model entity);
	...
	Task<OrganizationalLevel2Model> PatchAsync([Body] OrganizationalLevel2Model entity);
	...
	Task<QueryActionResult<OrganizationalLevel2Model>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<OrganizationalLevel2Model> GetAsync([AliasAs("id")] long id);
	...
	Task<OrganizationalLevel2Model> UpdateAsync([Body] OrganizationalLevel2Model entity);
	...
	Task<QueryActionResult<OrganizationalLevel2Model>> QueryAsync([AliasAs("search")] string search);
