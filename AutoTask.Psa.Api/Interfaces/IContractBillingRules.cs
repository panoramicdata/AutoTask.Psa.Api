...
/// </summary>
public interface IContractBillingRules
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractBillingRuleModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractBillingRuleModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractBillingRuleModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
