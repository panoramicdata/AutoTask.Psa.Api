...
public interface IContractBillingRules
{
	...
	Task<QueryActionResult<ContractBillingRuleModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContractBillingRuleModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContractBillingRuleModel>> QueryAsync([AliasAs("search")] string search);
