...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IInventoryTransfersApi
	{
		...
		Task<InventoryTransferModel> CreateAsync([Body] InventoryTransferModel entity);
		...
		Task<InventoryTransferModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<InventoryTransferModel> GetAsync([AliasAs("id")] long id);
		...
		Task<InventoryTransferModel> QueryAsync([AliasAs("search")] string search);
