...
public interface ITicketNotes
{
	...
	Task<TicketNoteModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<TicketNoteModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
