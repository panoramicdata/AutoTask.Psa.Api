...
public interface ITicketNotes
{
	...
	Task<QueryActionResult<TicketNoteModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<TicketNoteModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<TicketNoteModel>> QueryAsync([AliasAs("search")] string search);
