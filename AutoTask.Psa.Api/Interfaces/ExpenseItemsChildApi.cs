...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IExpenseItemsChildApi
	{
		...
		Task<ExpenseItemModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ExpenseItemModel entity);
		...
		Task<ExpenseItemModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] ExpenseItemModel entity);
		...
		Task<ExpenseItemModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] ExpenseItemModel entity);
	}
}
