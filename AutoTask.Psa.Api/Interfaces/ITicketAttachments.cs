...
/// </summary>
public interface ITicketAttachments
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<TicketAttachmentModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<TicketAttachmentModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<TicketAttachmentModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
