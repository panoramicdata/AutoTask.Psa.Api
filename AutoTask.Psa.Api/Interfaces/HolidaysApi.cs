...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IHolidaysApi
	{
		...
		Task<HolidayModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<HolidayModel> GetAsync([AliasAs("id")] long id);
		...
		Task<HolidayModel> QueryAsync([AliasAs("search")] string search);
