...
/// </summary>
public interface IContactWebhookExcludedResources
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContactWebhookExcludedResourceModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContactWebhookExcludedResourceModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContactWebhookExcludedResourceModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
