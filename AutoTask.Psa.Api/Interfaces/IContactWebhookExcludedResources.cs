...
public interface IContactWebhookExcludedResources
{
	...
	Task<QueryActionResult<ContactWebhookExcludedResourceModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContactWebhookExcludedResourceModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContactWebhookExcludedResourceModel>> QueryAsync([AliasAs("search")] string search);
