...
public interface IResourceRoleDepartments
{
	...
	Task<QueryActionResult<ResourceRoleDepartmentModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<QueryActionResult<ResourceRoleDepartmentModel>> QueryAsync([AliasAs("search")] string search);
