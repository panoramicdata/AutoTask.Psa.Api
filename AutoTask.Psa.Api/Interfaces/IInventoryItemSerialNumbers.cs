...
/// </summary>
public interface IInventoryItemSerialNumbers
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<InventoryItemSerialNumberModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<InventoryItemSerialNumberModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<InventoryItemSerialNumberModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
