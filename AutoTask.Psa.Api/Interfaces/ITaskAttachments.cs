...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface ITaskAttachmentsApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<TaskAttachmentModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<TaskAttachmentModel> GetAsync([AliasAs("id")] long id);
		...
		Task<TaskAttachmentModel> StringQueryAsync([AliasAs("search")] string search);
