...
public interface ITaskAttachments
{
	...
	Task<QueryActionResult<TaskAttachmentModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<QueryActionResult<TaskAttachmentModel>> QueryAsync([AliasAs("search")] string search);
