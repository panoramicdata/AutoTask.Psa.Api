...
public interface ICompanySiteConfigurationsApi
{
	...
	Task<CompanySiteConfigurationModel> QueryAsync([Body] QueryModel queryModel);
	...
	Task<CompanySiteConfigurationModel> GetAsync([AliasAs("id")] long id);
	...
	Task<CompanySiteConfigurationModel> StringQueryAsync([AliasAs("search")] string search);
