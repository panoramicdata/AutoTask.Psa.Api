...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IAdditionalInvoiceFieldValues
	{
		...
		Task<QueryActionResult<AdditionalInvoiceFieldValueModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<AdditionalInvoiceFieldValueModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<AdditionalInvoiceFieldValueModel>> QueryAsync([AliasAs("search")] string search);
