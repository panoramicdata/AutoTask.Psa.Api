...
/// </summary>
public interface IAdditionalInvoiceFieldValues
{
	/// <summary>
	/// Query
	/// </summary>
	...
	Task<QueryActionResult<AdditionalInvoiceFieldValueModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<AdditionalInvoiceFieldValueModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<AdditionalInvoiceFieldValueModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
