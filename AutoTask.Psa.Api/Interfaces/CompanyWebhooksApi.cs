...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICompanyWebhooksApi
	{
		...
		Task<CompanyWebhookModel> CreateAsync([Body] CompanyWebhookModel entity);
		...
		Task<CompanyWebhookModel> PatchAsync([Body] CompanyWebhookModel entity);
		...
		Task<CompanyWebhookModel> GetAsync([AliasAs("id")] long id);
		...
		Task<CompanyWebhookModel> UpdateAsync([Body] CompanyWebhookModel entity);
		...
		Task<CompanyWebhookModel> StringQueryAsync([AliasAs("search")] string search);
