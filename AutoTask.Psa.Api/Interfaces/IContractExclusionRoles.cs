...
public interface IContractExclusionRoles
{
	...
	Task<QueryActionResult<ContractExclusionRoleModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractExclusionRoleModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractExclusionRoleModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
