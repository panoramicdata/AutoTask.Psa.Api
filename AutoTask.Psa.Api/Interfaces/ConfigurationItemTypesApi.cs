...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface IConfigurationItemTypesApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<ConfigurationItemTypeModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ConfigurationItemTypeModel> QueryAsync([AliasAs("search")] string search);
