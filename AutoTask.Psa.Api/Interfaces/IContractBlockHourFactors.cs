...
public interface IContractBlockHourFactors
{
	...
	Task<QueryActionResult<ContractBlockHourFactorModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContractBlockHourFactorModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContractBlockHourFactorModel>> QueryAsync([AliasAs("search")] string search);
