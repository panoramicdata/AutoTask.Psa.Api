...
/// </summary>
public interface IContractBlockHourFactors
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractBlockHourFactorModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractBlockHourFactorModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractBlockHourFactorModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
