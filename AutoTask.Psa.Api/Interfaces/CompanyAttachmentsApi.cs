...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface ICompanyAttachmentsApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<CompanyAttachmentModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<CompanyAttachmentModel> GetAsync([AliasAs("id")] long id);
		...
		Task<CompanyAttachmentModel> StringQueryAsync([AliasAs("search")] string search);
