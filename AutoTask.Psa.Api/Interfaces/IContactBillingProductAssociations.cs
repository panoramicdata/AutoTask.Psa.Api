...
/// </summary>
public interface IContactBillingProductAssociations
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContactBillingProductAssociationModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContactBillingProductAssociationModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContactBillingProductAssociationModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
