...
public interface IContactBillingProductAssociations
{
	...
	Task<QueryActionResult<ContactBillingProductAssociationModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContactBillingProductAssociationModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContactBillingProductAssociationModel>> QueryAsync([AliasAs("search")] string search);
