...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	/// </summary>
	public interface IContractNotesApi
	{
		/// <summary>
		///
		/// </summary>
		...
		Task<ContractNoteModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ContractNoteModel> StringQueryAsync([AliasAs("search")] string search);
