...
public interface IPriceListWorkTypeModifiers
{
	...
	Task<PriceListWorkTypeModifierModel> PatchAsync([Body] PriceListWorkTypeModifierModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<PriceListWorkTypeModifierModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<PriceListWorkTypeModifierModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<PriceListWorkTypeModifierModel> UpdateAsync([Body] PriceListWorkTypeModifierModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<PriceListWorkTypeModifierModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
