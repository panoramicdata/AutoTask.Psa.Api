...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IPurchaseOrderItemsChildApi
	{
		...
		Task<PurchaseOrderItemModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] PurchaseOrderItemModel entity);
		...
		Task<PurchaseOrderItemModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] PurchaseOrderItemModel entity);
		...
		Task<PurchaseOrderItemModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] PurchaseOrderItemModel entity);
	}
}
