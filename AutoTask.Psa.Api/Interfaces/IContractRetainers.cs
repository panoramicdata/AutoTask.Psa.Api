...
/// </summary>
public interface IContractRetainers
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<ContractRetainerModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ContractRetainerModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ContractRetainerModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
