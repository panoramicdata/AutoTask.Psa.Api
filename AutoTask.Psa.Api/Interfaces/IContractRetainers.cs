...
public interface IContractRetainers
{
	...
	Task<QueryActionResult<ContractRetainerModel>> QueryAsync([Body] QueryModel queryModel);
	...
	Task<ContractRetainerModel> GetAsync([AliasAs("id")] long id);
	...
	Task<QueryActionResult<ContractRetainerModel>> QueryAsync([AliasAs("search")] string search);
