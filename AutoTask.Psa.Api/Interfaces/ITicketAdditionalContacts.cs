...
/// </summary>
public interface ITicketAdditionalContacts
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<TicketAdditionalContactModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<TicketAdditionalContactModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<TicketAdditionalContactModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
