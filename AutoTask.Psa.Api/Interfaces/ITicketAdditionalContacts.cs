...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ITicketAdditionalContacts
	{
		...
		Task<QueryActionResult<TicketAdditionalContactModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<QueryActionResult<TicketAdditionalContactModel>> QueryAsync([AliasAs("search")] string search);
