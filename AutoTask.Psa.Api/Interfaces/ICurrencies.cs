...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICurrencies
	{
		...
		Task<CurrencyModel> PatchAsync([Body] CurrencyModel entity);
		...
		Task<CurrencyModel> GetAsync([AliasAs("id")] long id);
		...
		/// <returns>Task of CurrencyModel</returns>
		[Put("/V1.0/Currencies")]
		Task<CurrencyModel> UpdateAsync([Body] CurrencyModel entity);
		...
		Task<QueryActionResult<CurrencyModel>> QueryAsync([AliasAs("search")] string search);
