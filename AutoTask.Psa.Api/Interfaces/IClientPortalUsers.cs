...
/// </summary>
public interface IClientPortalUsers
{
	/// <summary>
	///
	/// </summary>
	...
	Task<ClientPortalUserModel> CreateAsync([Body] ClientPortalUserModel entity, CancellationToken cancellationToken);
	...
	Task<ClientPortalUserModel> PatchAsync([Body] ClientPortalUserModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ClientPortalUserModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<ClientPortalUserModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<ClientPortalUserModel> UpdateAsync([Body] ClientPortalUserModel entity, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<ClientPortalUserModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
