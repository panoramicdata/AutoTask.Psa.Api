...
public interface IPhasesChild
{
	...
	Task<PhaseModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] PhaseModel entity, CancellationToken cancellationToken);
	...
	Task<PhaseModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] PhaseModel entity, CancellationToken cancellationToken);
	...
	Task<PhaseModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] PhaseModel entity, CancellationToken cancellationToken);
}
