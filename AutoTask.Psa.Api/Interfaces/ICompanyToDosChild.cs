...
public interface ICompanyToDosChild
{
	...
	Task<CompanyToDoModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] CompanyToDoModel entity, CancellationToken cancellationToken);
	...
	Task<CompanyToDoModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] CompanyToDoModel entity, CancellationToken cancellationToken);
	...
	Task<CompanyToDoModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] CompanyToDoModel entity, CancellationToken cancellationToken);
}
