...
/// </summary>
public interface ICompanyWebhookFields
{
	/// <summary>
	///
	/// </summary>
	...
	Task<QueryActionResult<CompanyWebhookFieldModel>> QueryAsync([Body] QueryModel queryModel, CancellationToken cancellationToken);
	...
	Task<CompanyWebhookFieldModel> GetAsync([AliasAs("id")] long id, CancellationToken cancellationToken);
	...
	Task<QueryActionResult<CompanyWebhookFieldModel>> QueryAsync([AliasAs("search")] string search, CancellationToken cancellationToken);
