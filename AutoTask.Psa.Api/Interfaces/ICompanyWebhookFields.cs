...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface ICompanyWebhookFields
	{
		...
		Task<QueryActionResult<CompanyWebhookFieldModel>> QueryAsync([Body] QueryModel queryModel);
		...
		Task<CompanyWebhookFieldModel> GetAsync([AliasAs("id")] long id);
		...
		Task<QueryActionResult<CompanyWebhookFieldModel>> QueryAsync([AliasAs("search")] string search);
