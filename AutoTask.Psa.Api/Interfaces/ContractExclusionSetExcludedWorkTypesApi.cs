...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IContractExclusionSetExcludedWorkTypesApi
	{
		...
		Task<ContractExclusionSetExcludedWorkTypeModel> QueryAsync([Body] QueryModel queryModel);
		...
		Task<ContractExclusionSetExcludedWorkTypeModel> GetAsync([AliasAs("id")] long id);
		...
		Task<ContractExclusionSetExcludedWorkTypeModel> QueryAsync([AliasAs("search")] string search);
