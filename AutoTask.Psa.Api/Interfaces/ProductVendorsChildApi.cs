...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IProductVendorsChildApi
	{
		...
		Task<ProductVendorModel> CreateAsync([AliasAs("parentId")] long? parentId, [Body] ProductVendorModel entity);
		...
		Task<ProductVendorModel> PatchAsync([AliasAs("parentId")] long? parentId, [Body] ProductVendorModel entity);
		...
		Task<ProductVendorModel> UpdateAsync([AliasAs("parentId")] long? parentId, [Body] ProductVendorModel entity);
	}
}
