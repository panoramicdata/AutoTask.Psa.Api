...
namespace AutoTask.Psa.Api.Interfaces
{
	...
	public interface IContractExclusionSetExcludedRolesApi
	{
		...
		Task<ContractExclusionSetExcludedRoleModel> GetAsync([AliasAs("id")] long id);
		...
		Task<ContractExclusionSetExcludedRoleModel> StringQueryAsync([AliasAs("search")] string search);
