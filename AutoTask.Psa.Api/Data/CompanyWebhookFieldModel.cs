...
namespace AutoTask.Psa.Api.Data
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="CompanyWebhookFieldModel" /> class.
		/// </summary>
		...
		public CompanyWebhookFieldModel(long? Id = default, int? FieldID = default, bool? IsDisplayAlwaysField = default, bool? IsSubscribedField = default, int? WebhookID = default, List<UserDefinedField> UserDefinedFields = default)
		{
			this.Id = Id;
		...
		public ExpressionFuncAccountWebhookFieldInt64 SoapParentPropertyId { get; private set; }
		/// <summary>
