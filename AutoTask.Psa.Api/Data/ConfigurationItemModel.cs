...
namespace AutoTask.Psa.Api.Data
{
	...
	public partial class ConfigurationItemModel
	{
		...
		public ConfigurationItemModel(long? Id = default, int? ApiVendorID = default, int? ConfigurationItemCategoryID = default, int? CompanyID = default, int? CompanyLocationID = default, int? ConfigurationItemType = default, int? ContactID = default, int? ContractID = default, int? ContractServiceBundleID = default, int? ContractServiceID = default, DateTime? CreateDate = default, int? CreatedByPersonID = default, double? DailyCost = default, long? DattoAvailableKilobytes = default, int? DattoDeviceMemoryMegabytes = default, bool? DattoDrivesErrors = default, string DattoHostname = default, string DattoInternalIP = default, int? DattoKernelVersionID = default, DateTime? DattoLastCheckInDateTime = default, int? DattoNICSpeedKilobitsPerSecond = default, int? DattoNumberOfAgents = default, int? DattoNumberOfDrives = default, int? DattoNumberOfVolumes = default, long? DattoOffsiteUsedBytes = default, int? DattoOSVersionID = default, double? DattoPercentageUsed = default, long? DattoProtectedKilobytes = default, string DattoRemoteIP = default, string DattoSerialNumber = default, int? DattoUptimeSeconds = default, long? DattoUsedKilobytes = default, int? DattoZFSVersionID = default, string DeviceNetworkingID = default, double? HourlyCost = default, int? ImpersonatorCreatorResourceID = default, DateTime? InstallDate = default, int? InstalledByContactID = default, int? InstalledByID = default, bool? IsActive = default, int? LastActivityPersonID = default, int? LastActivityPersonType = default, DateTime? LastModifiedTime = default, string Location = default, double? MonthlyCost = default, string Notes = default, double? NumberOfUsers = default, int? ParentConfigurationItemID = default, double? PerUseCost = default, int? ProductID = default, string ReferenceNumber = default, string ReferenceTitle = default, int? RMMDeviceAuditAntivirusStatusID = default, int? RMMDeviceAuditArchitectureID = default, int? RMMDeviceAuditBackupStatusID = default, string RMMDeviceAuditDescription = default, int? RMMDeviceAuditDeviceTypeID = default, int? RMMDeviceAuditDisplayAdaptorID = default, int? RMMDeviceAuditDomainID = default, string RMMDeviceAuditExternalIPAddress = default, string RMMDeviceAuditHostname = default, string RMMDeviceAuditIPAddress = default, string RMMDeviceAuditLastUser = default, string RMMDeviceAuditMacAddress = default, int? RMMDeviceAuditManufacturerID = default, long? RMMDeviceAuditMemoryBytes = default, int? RMMDeviceAuditMissingPatchCount = default, int? RMMDeviceAuditMobileNetworkOperatorID = default, string RMMDeviceAuditMobileNumber = default, int? RMMDeviceAuditModelID = default, int? RMMDeviceAuditMotherboardID = default, string RMMDeviceAuditOperatingSystem = default, int? RMMDeviceAuditPatchStatusID = default, int? RMMDeviceAuditProcessorID = default, int? RMMDeviceAuditServicePackID = default, string RMMDeviceAuditSNMPContact = default, string RMMDeviceAuditSNMPLocation = default, string RMMDeviceAuditSNMPName = default, int? RMMDeviceAuditSoftwareStatusID = default, long? RMMDeviceAuditStorageBytes = default, long? RMMDeviceID = default, string RMMDeviceUID = default, int? RMMOpenAlertCount = default, string SerialNumber = default, int? ServiceBundleID = default, int? ServiceID = default, int? ServiceLevelAgreementID = default, double? SetupFee = default, int? SourceChargeID = default, int? SourceChargeType = default, int? VendorID = default, DateTime? WarrantyExpirationDate = default, List<UserDefinedField> UserDefinedFields = default)
		{
			this.Id = Id;
