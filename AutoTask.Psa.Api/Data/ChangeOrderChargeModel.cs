...
namespace AutoTask.Psa.Api.Data
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ChangeOrderChargeModel" /> class.
		/// </summary>
		/// <param name="Id">Id.</param>
		/// <param name="BillableAmount">BillableAmount.</param>
		/// <param name="BillingCodeID">BillingCodeID.</param>
		/// <param name="ChangeOrderHours">ChangeOrderHours.</param>
		...
		public ChangeOrderChargeModel(long? Id = default, double? BillableAmount = default, int? BillingCodeID = default, double? ChangeOrderHours = default, int? ChargeType = default, int? ContractServiceBundleID = default, int? ContractServiceID = default, DateTime? CreateDate = default, int? CreatorResourceID = default, DateTime? DatePurchased = default, string Description = default, double? ExtendedCost = default, double? InternalCurrencyBillableAmount = default, double? InternalCurrencyUnitPrice = default, string InternalPurchaseOrderNumber = default, bool? IsBillableToCompany = default, bool? IsBilled = default, string Name = default, string Notes = default, int? OrganizationalLevelAssociationID = default, int? ProductID = default, string PurchaseOrderNumber = default, int? Status = default, int? StatusLastModifiedBy = default, DateTime? StatusLastModifiedDate = default, int? TaskID = default, double? UnitCost = default, double? UnitPrice = default, double? UnitQuantity = default, List<UserDefinedField> UserDefinedFields = default)
		{
			this.Id = Id;
			this.BillableAmount = BillableAmount;
			this.BillingCodeID = BillingCodeID;
			this.ChangeOrderHours = ChangeOrderHours;
