...
namespace AutoTask.Psa.Api.Data
{
	...
	public partial class PurchaseOrderModel
	{
		...
		public PurchaseOrderModel(long? Id = default, DateTime? CancelDateTime = default, DateTime? CreateDateTime = default, int? CreatorResourceID = default, string ExternalPONumber = default, string Fax = default, double? Freight = default, string GeneralMemo = default, int? ImpersonatorCreatorResourceID = default, double? InternalCurrencyFreight = default, DateTime? LatestEstimatedArrivalDate = default, int? PaymentTerm = default, string Phone = default, int? PurchaseForCompanyID = default, DateTime? ShippingDate = default, int? ShippingType = default, string ShipToAddress1 = default, string ShipToAddress2 = default, string ShipToCity = default, string ShipToName = default, string ShipToPostalCode = default, string ShipToState = default, bool? ShowEachTaxInGroup = default, bool? ShowTaxCategory = default, int? Status = default, DateTime? SubmitDateTime = default, int? TaxRegionID = default, int? UseItemDescriptionsFrom = default, int? VendorID = default, string VendorInvoiceNumber = default, List<UserDefinedField> UserDefinedFields = default)
		{
			this.Id = Id;
