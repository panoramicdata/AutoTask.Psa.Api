...
namespace AutoTask.Psa.Api.Data
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="CompanyWebhookUdfFieldModel" /> class.
		/// </summary>
		...
		public CompanyWebhookUdfFieldModel(long? Id = default, bool? IsDisplayAlwaysField = default, bool? IsSubscribedField = default, int? UdfFieldID = default, int? WebhookID = default, List<UserDefinedField> UserDefinedFields = default)
		{
			this.Id = Id;
		...
		public ExpressionFuncAccountWebhookUdfFieldInt64 SoapParentPropertyId { get; private set; }
		/// <summary>
