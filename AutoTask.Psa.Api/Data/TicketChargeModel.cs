...
namespace AutoTask.Psa.Api.Data
{
	...
	/// </summary>
	[DataContract]
	public partial class TicketChargeModel
	{
		/// <summary>
		...
		public TicketChargeModel(long? Id = default, double? BillableAmount = default, long? BillingCodeID = default, int? ChargeType = default, long? ContractServiceBundleID = default, long? ContractServiceID = default, DateTime? CreateDate = default, long? CreatorResourceID = default, DateTime? DatePurchased = default, string Description = default, double? ExtendedCost = default, double? InternalCurrencyBillableAmount = default, double? InternalCurrencyUnitPrice = default, string InternalPurchaseOrderNumber = default, bool? IsBillableToCompany = default, bool? IsBilled = default, string Name = default, string Notes = default, int? OrganizationalLevelAssociationID = default, long? ProductID = default, string PurchaseOrderNumber = default, long? Status = default, long? StatusLastModifiedBy = default, DateTime? StatusLastModifiedDate = default, long? TicketID = default, double? UnitCost = default, double? UnitPrice = default, double? UnitQuantity = default, List<UserDefinedField> UserDefinedFields = default)
		{
			this.Id = Id;
